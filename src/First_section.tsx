    ...
    <div className = "w-container flex flex-col sm:flex-row justify-between blade-top-padding-sm blade-bottom-padding-sm">
        <div className = "sm:mega text-xl font-medium sm:min-w-[50%] sm:order-1 order-2 sm:pt-0 blade-top-padding gsap-slide-in">
            ...
            <div className = "flex justify-between  sm:max-w-[80%] pt-4">
               ...
               <h4 className = "relative sm:text-right text-center text-white  sm:max-w-[45%] leading-tight font-semibold inline-block group pb-1 cursor-pointer">
        ...
        <div className = "min-w-[50%] relative sm:order-2 order-1 gsap-slide-in">
           ...
           <div className="absolute sm:text-xl top-4 left-4 bg-transparent bg-opacity-60 px-3 py-1 rounded-md text-sm font-medium group cursor-pointer">
              <span className="text-white bg-clip-text bg-gradient-to-r from-blue-500 to-green-400 transition-all duration-500 group-hover:text-transparent">
                 Your Business Boost
              </span>
           </div>

        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-[90%] sm:w-[80%]">
             <button className="relative group w-full px-4 py-2 border border-white text-white rounded-full overflow-hidden bg-transparent flex justify-between items-center transition-all duration-500">
